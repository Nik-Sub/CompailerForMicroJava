...
public class CondTermListClass extends CondTermList {

    private CondTerm CondTerm;
    private CondTermList CondTermList;

    public CondTermListClass (CondTerm CondTerm, CondTermList CondTermList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondTermListClass(\n");
