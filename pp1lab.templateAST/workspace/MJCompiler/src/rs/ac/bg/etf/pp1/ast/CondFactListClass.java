...
public class CondFactListClass extends CondFactList {

    private CondFact CondFact;
    private CondFactList CondFactList;

    public CondFactListClass (CondFact CondFact, CondFactList CondFactList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondFactListClass(\n");
